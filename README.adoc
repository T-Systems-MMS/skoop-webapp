...
In order to set up the OIDC login you need to install KeyCloak and configure a suitable realm. Please see the https://github.com/KnowledgeAssets/myskills-server[MySkills Server] for some hints and a preconfigured KeyCloak realm.
