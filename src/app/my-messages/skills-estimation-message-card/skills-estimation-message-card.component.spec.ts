...
describe('SkillsEstimationMessageCardComponent', () => {
  ...
  it('should build message for multiple skills', () => {
    ...
    expect(element.nativeElement.innerText).toBe('You need to estimate the skills Java, JavaScript. You can do this on the My skill profile page');
  });
  ...
  it('should build message for one skill', () => {
    ...
    fixture.detectChanges();
    const element = fixture.debugElement.query(By.css('.messages-message-text'));
    expect(element.nativeElement.innerText).toBe('You need to estimate the skill Java. You can do this on the My skill profile page');
  });
});
